...
import com.focused_ai.models.domain.Course;
...
public class MoodleService {
    ...
    public CourseList getCourses(String userId) throws Exception {
        ...
        MoodleCourseList courses = apiClient.getCourses(moodleUrl, userWSToken);
        if (courses == null) {
