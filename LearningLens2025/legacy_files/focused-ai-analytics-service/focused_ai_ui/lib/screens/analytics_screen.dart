...
import 'package:focused_ai_ui/models/CourseWorkWithSubmissions.dart';
import 'package:focused_ai_ui/models/grade.dart';
import 'package:focused_ai_ui/models/participant.dart';
import '../models/course.dart';
import '../models/assessment.dart';
import '../services/analytics_services.dart';
import 'student_chart.dart'; // from earlier step
...
void exportCsvWeb(String csvContent, String fileName) {
  ...
  Map<String, double> _calculateAverageGradesPerQuiz(List<Grade> grades) {
    ...
    for (final g in grades) {
      grouped.putIfAbsent(g.assignmentTitle, () => []).add(g.grade);
    }
          ...
          DropdownButtonFormField<int>(
            ...
            items: _courses.map((course) {
              return DropdownMenuItem<int>(
                value: course.id,
                child: Text(course.fullName ?? course.shortName),
              );
            }).toList(),
            onChanged: (value) {
...
Align(
  ...
  onPressed: () {
    ...
    for (final grade in _grades) {
      csvBuffer.writeln("${grade.assignmentTitle},${grade.studentId},${grade.grade}");
    }
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          title: Text(g.assignmentTitle),
                          subtitle: Text('Student ID: ${g.studentId}'),
                          trailing: Text(
                            g.grade.toStringAsFixed(1),
