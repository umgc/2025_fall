...
class MoodleApi {
  ...
  Future<dynamic> protectedRequest(
    ...
    final uri = Uri.parse('${ServerConstants.ogServerUrl}$endpoint');
    try {
  ...
  Future<Map<String, dynamic>?> moodleLogin(
    ...
    final Uri uri = Uri.parse(
      '${ServerConstants.ogServerUrl}${ServerConstants.moodleLoginEndpoint}',
    );
  ...
  // Export CAILA-generated material to Moodle
  Future<Map<String, dynamic>> exportMaterial({
    required String authToken,
    required Map<String, dynamic> exportData,
  }) async {
    try {
      final response = await protectedRequest('POST', '/moodle/export', body: exportData);
