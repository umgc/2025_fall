...
class _VisitCompletePageState extends State<VisitCompletePage> {
  ...
  Future<void> _completeVisit() async {
    ...
    try {
      ...
      final patientName = '${_selectedPatient!.firstName} ${_selectedPatient!.lastName}';
      final request = EvvRecordRequest(
        serviceType: widget.serviceType,
        individualName: patientName,
        participantMaNumber: _selectedPatient!.maNumber ?? widget.patientId.toString(),
        ...
        stateCode: _selectedPatient!.address?.state ?? 'MD',
      );
