                      ...
                      lineBarsData: [
                        LineChartBarData(
                          ...
                          belowBarData: BarAreaData(
                            show: true,
                            color: (primaryColor ?? themePrimary).withValues(
                              alpha: 0.1,
                            ),
                          ),
                        ),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.blue.withValues(alpha: isDarkMode ? 0.3 : 0.2),
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(
                    color: Colors.blue.withValues(alpha: isDarkMode ? 0.4 : 0.3),
                  ),
                ),
                child: Text(
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.green.withValues(alpha: isDarkMode ? 0.2 : 0.15),
                    borderRadius: BorderRadius.circular(4),
                    border: Border.all(
                      color: Colors.green.withValues(alpha: isDarkMode ? 0.4 : 0.3),
                    ),
                  ),
                  child: Text(
