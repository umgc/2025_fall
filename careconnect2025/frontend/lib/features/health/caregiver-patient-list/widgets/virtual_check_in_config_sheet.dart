...
class VirtualCheckInConfigSheet extends StatefulWidget {
  ...
  const VirtualCheckInConfigSheet({super.key, required this.initial});
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ..._items.asMap().entries.map((e) {
                        ...
                        return Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // row: colorful icon • type badge • required • index • trash
                              Row(
                                children: [
                      ...
                      // Subtitles: left “Question Type” • right “Options”
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                        ...
                        children: [
                          Expanded(
                            child: DropdownMenu<CheckInQuestionType>(
                              ...
                              _newType = v ?? CheckInQuestionType.numerical),
                        ...
                        child: FilledButton.icon(
                          ...
                          onPressed: _newTextCtrl.text.trim().isEmpty
                            ...
                            setState(() {
                              ...
                              _newTextCtrl.clear(); // reset text only; keep type/required
                            });
                          },
                      ...
                      FilledButton.icon(
                        style: FilledButton.styleFrom(
                          ...
                          foregroundColor: Theme.of(context).brightness == Brightness.dark
                              ...
                              : Theme.of(context).colorScheme.onPrimary, // normal theme in light mode
