...
18. [Electronic Visit Verification](#electronic-visit-verification)
...
- **CareConnect Emergency Support**: Available 24/7 through app
- **Poison Control**: 1-800-222-1222 (US)
- **Mental Health Crisis**: 988 Suicide & Crisis Lifeline (US)
...
### Quick Actions
- **Log Health Data**: Dashboard → "Quick Log" button
- **Start Video Call**: Dashboard → "Video Call" button
- **Send Emergency Alert**: Long press emergency button (3 seconds)
- **Access AI Assistant**: "Hey CareConnect" voice command or chat icon
...
For the most current version of this guide, please visit your CareConnect web portal or check the in-app help section.
